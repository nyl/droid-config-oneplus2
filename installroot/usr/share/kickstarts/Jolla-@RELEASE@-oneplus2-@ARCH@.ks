# DisplayName: Jolla oneplus2/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: oneplus2
# DeviceVariant: oneplus2
...
repo --name=adaptation-community-common-oneplus2-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration oneplus2
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/oneplus2
